...
#' 
#' occ.pnts <- sdm_to_occ.pnts(env = env.pres, occ = occ_train, algorithms = c('svm', 'maxent', 'rf', 'brt', 'domain'), predict_object = p_pres)
#' 
